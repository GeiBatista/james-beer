...
JamesBeer.ComboEstado = (function() {
...
JamesBeer.ComboCidade = (function() {
...
$(function() {
	var comboEstado = new JamesBeer.ComboEstado();
	comboEstado.iniciar();
	
	var comboCidade = new JamesBeer.ComboCidade(comboEstado);
	comboCidade.iniciar();
